...
class RegistroForm(forms.ModelForm):
    ciudad_id = forms.ModelChoiceField(queryset=Ciudad.objects.all(), widget=forms.Select(attrs={'placeholder': 'Ciudad'}), empty_label='Seleccione una Ciudad')
    ...
    numero_documento = forms.CharField(max_length=255, widget=forms.TextInput(attrs={'placeholder': 'Nro. De Documento'}))
